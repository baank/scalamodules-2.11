...
//  lazy val publishTo = "Scala Tools Nexus" at "http://nexus.scala-tools.org/content/repositories/releases/"
   val publishTo = "Scala Tools Nexus" at "https://nexus.ad.colesfinancialservices.com.au/content/repositories/colesfs-librares/"
//  lazy val publishTo = Resolver.file("Local Test Repository", Path fileProperty "java.io.tmpdir" asFile)
  //resolvers += "nexus" at "https://nexus.ad.colesfinancialservices.com.au/content/repositories/releases/"
  //resolvers += "nexuslib" at "https://nexus.ad.colesfinancialservices.com.au/content/repositories/colesfs-libraries/"
